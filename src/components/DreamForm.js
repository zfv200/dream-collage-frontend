    ...
    return (
      <div>
        <form onSubmit={this.handleSubmit}>
          <h1 className="dream-font">Tell me about your dream...</h1>
          <TextArea className="text-area" onChange={this.handleChange} name="content"/>
          <br/>
          <h1 className="dream-font">What adjectives would you use to describe the dream?</h1>
          <TextArea className="text-area" onChange={this.handleChange} name="adjectives"/>
          <br/>
          <h1 className="dream-font">Describe the overall mood in one word...</h1>
